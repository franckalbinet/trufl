...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'trufl.callbacks': { 'trufl.callbacks.Callback': ('callbacks.html#callback', 'trufl/callbacks.py'),
            ...
            'trufl.optimizer': { 'trufl.optimizer.Optimizer': ('optimizer.html#optimizer', 'trufl/optimizer.py'),
                                 'trufl.optimizer.Optimizer.CP_distance': ('optimizer.html#optimizer.cp_distance', 'trufl/optimizer.py'),
                                 ...
                                 'trufl.optimizer.Optimizer.build_weight_vector': ( 'optimizer.html#optimizer.build_weight_vector',
                                                                                    'trufl/optimizer.py'),
